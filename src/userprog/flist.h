 ...
 * each file descriptor. This flistping is for you to solve, and the
 ...
 * std::flist is recommended.
 *
 * This structure can be placed either globally or locally for each
 * process. If you go for a global flist, consider how to remember which
 * process that opened each file. If you go for a local flist, consider
